<?php
    ...
    if ( ! function_exists( 'turio_breadcrumb' ) ) {
		 ...
		 * @since   1.4.0
		 */
        function turio_breadcrumb ( $list_style = 'ol', $list_id = 'breadcrumb', $list_class = 'breadcrumb', $active_class = 'active', $echo = true ) {
            ...
            if ( is_page() && ! is_front_page() ) {
                ...
                if ( $post->post_parent ) {
                    ...
                    while ( $parent_id ) {
                        ...
                        $crumbs[] = '<a href="' . esc_url(get_permalink( $page->ID )) . '">' . get_the_title( $page->ID ) . '</a>';
            ...
            // Search
            if ( is_search() ) {
                $breadcrumb .= '<li class="' . $active_class . '">' . esc_html__( 'Search', 'turio' ) . '</li>';
            }

            // 404
            if ( is_404() ) {
                $breadcrumb .= '<li class="' . $active_class . '">' . esc_html__( '404', 'turio' ) . '</li>';
            }
            ...
            // Ouput
            if ( $echo ) {
                echo sprintf( esc_html__("%s", 'turio'), $breadcrumb ); ;
            } else {
                return $breadcrumb;
            }
        }
